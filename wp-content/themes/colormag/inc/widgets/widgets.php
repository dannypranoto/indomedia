...
function colormag_widgets_init() {
   ...
   // registering the Community Page: Content Top Section Sidebar
   register_sidebar( array(
      'name'            => __( 'Community Page: Content Top Section', 'colormag' ),
      'id'              => 'colormag_community_page_content_top_section',
      'description'     => __( 'Content Top Section', 'colormag' ),
      'before_widget'   => '<section id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</section>',
      'before_title'    => '<h3 class="widget-title"><span>',
   ...
   // registering the Lifestyle Page: Content Top Section Sidebar
   register_sidebar( array(
      'name'            => __( 'Lifestyle Page: Content Top Section', 'colormag' ),
      'id'              => 'colormag_lifestyle_page_content_top_section',
      'description'     => __( 'Content Top Section', 'colormag' ),
      'before_widget'   => '<section id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</section>',
      'before_title'    => '<h3 class="widget-title"><span>',
   ...
   // registering the Lifestyle Page: Content Middle Left Section Sidebar
   register_sidebar( array(
      'name'            => __( 'Lifestyle Page: Content Middle Left Section', 'colormag' ),
      'id'              => 'colormag_lifestyle_page_content_middle_left_section',
   ...
   // registering the Lifestyle Page: Content Middle Right Section Sidebar
   register_sidebar( array(
      'name'            => __( 'Lifestyle Page: Content Middle Right Section', 'colormag' ),
      'id'              => 'colormag_lifestyle_page_content_middle_right_section',
   ...
   // registering the Lifestyle Page: Content Bottom Section Sidebar
   register_sidebar( array(
      'name'            => __( 'Lifestyle Page: Content Bottom Section', 'colormag' ),
      'id'              => 'colormag_lifestyle_page_content_bottom_section',
   ...
   // registering the Lifestyle Page: Content Bottom Left Section Sidebar
   register_sidebar( array(
      'name'            => __( 'Lifestyle Page: Content Bottom Left Section', 'colormag' ),
      'id'              => 'colormag_lifestyle_page_content_bottom_left_section',
      'description'     => __( 'Content Bottom Left Section', 'colormag' ),
      'before_widget'   => '<section id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</section>',
      'before_title'    => '<h3 class="widget-title"><span>',
      'after_title'     => '</span></h3>'
   ...
   // registering the Lifestyle Page: Content Bottom Right Section Sidebar
   register_sidebar( array(
      'name'            => __( 'Lifestyle Page: Content Bottom Right Section', 'colormag' ),
      'id'              => 'colormag_lifestyle_page_content_bottom_right_section',
      'description'     => __( 'Content Bottom Right Section', 'colormag' ),
      'before_widget'   => '<section id="%1$s" class="widget %2$s clearfix">',
      'after_widget'    => '</section>',
      'before_title'    => '<h3 class="widget-title"><span>',
      'after_title'     => '</span></h3>'
