...
function srz_fb_enqueue_script() {
	...
	wp_enqueue_script('srzcustom', srz_fb_get_resource_url('js/srizon.custom.min.js'), array('jquery'),'2.3');
	...
	wp_enqueue_style('srzcustomcss', srz_fb_get_resource_url('css/srizon.custom.min.css'), null, '2.3');
}